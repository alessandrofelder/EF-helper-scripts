...
import time
import datetime
workingDir =  "/media/alessandro/Seagate Expansion Drive/new-vertebra-study/"
...
f.write('#\n')
f.write("file,runs,weighted,shift,vectors,skipRatio,maxIterations,filter,contact,step,distanceThreshold,time\n")
f.close()
