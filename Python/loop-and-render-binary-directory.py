...
#directory = '/media/alessandro/Seagate Expansion Drive/disuse-study-final-with-topo/EF/'
#directory = '/media/alessandro/Seagate Expansion Drive/filter-contact-step-study/EF/'
directory = '/media/alessandro/Seagate Expansion Drive/vertebra-study-small-step-dave/original-images/'
...
for filename in listdir(directory):
    if filename.endswith(".tif"): 
		...
		threshold1.ThresholdRange = [1,255]
		...
		# save screenshot
		SaveScreenshot(directory+name.replace(".tif","")+'-test-bla.png', renderView1, ImageResolution=[984, 961], 
		    # PNG options
		    CompressionLevel='0')
