...
## DIAGNOSIS BY ALE! DO NOT TRUST
v$porotic <- as.factor(c("osteoporotic","osteoporotic","osteoporotic","non-osteoporotic","non-osteoporotic","osteoporotic","non-osteoporotic","osteoporotic","non-osteoporotic","non-osteoporotic"))
...
legend(0.05,-0.2,c("median","maximum","minimum"), pch=c(21,21,21),pt.bg=c(rgb(237,73,1,maxColorValue = 255),rgb(1,0.988,0.29,maxColorValue = 1),rgb(0.21,0,0.67,maxColorValue = 1)))
dev.off()
